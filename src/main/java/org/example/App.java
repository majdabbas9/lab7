...
public class App
{
    ...
    private static void initializeData() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Image image=new Image("https://www.google.co.il/url?sa=i&url=https%3A%2F%2Fwww.cardekho.com%2Ftoyota%2Fsupra&psig=AOvVaw1UR17WdRvJChfOszCQzFnn&ust=1684333254853000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCJizwL6E-v4CFQAAAAAdAAAAABAE");
            car.setImage(image);
            image.setCar(car);
            session.save(car);
            session.save(image);
